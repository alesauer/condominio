...
@router.get("", response_model=PaginatedResponse[AguaRateioResponse], dependencies=[Depends(admin_required)])
...
@router.get("/{rateio_id}", response_model=AguaRateioResponse, dependencies=[Depends(admin_required)])
